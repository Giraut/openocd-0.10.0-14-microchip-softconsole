...
function prepare_xbb_env() 
{
  ...
  BUILD_GIT_PATH="${WORK_FOLDER_PATH}/build_scripts"
...
{
  rm -rf "${HOST_WORK_FOLDER_PATH}/build_scripts"
  mkdir -pv "${HOST_WORK_FOLDER_PATH}/build_scripts"
  cp -r "$(dirname ${script_folder_path})"/* "${HOST_WORK_FOLDER_PATH}/build_scripts"
  rm -rf "${HOST_WORK_FOLDER_PATH}/build_scripts/scripts/helper/.git"
  rm -rf "${HOST_WORK_FOLDER_PATH}/build_scripts/scripts/helper/build-helper.sh"
}
...
function copy_distro_files()
{
  (
    ...
    cd "${WORK_FOLDER_PATH}/build_scripts"
